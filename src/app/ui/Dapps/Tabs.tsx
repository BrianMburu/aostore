...
import DappReviewForm from "./Review/DappReviewForm";
...
export function InfoTab({ appData }: { appData: AppData }) {
...
export function ReviewsTab({ reviews, setReviews, totalReviews }: {
    reviews: Review[],
    ...
    return (
        <div className="space-y-8">
            ...
            <DappReviews reviews={reviews} totalItems={totalReviews} />
        </div>)
}